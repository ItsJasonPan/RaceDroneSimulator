...
class RaceDrone(ShowBase):
    def __init__(self):
        ...
        self.keyMap = {
            ...
            "restart": 0, "firstPerson": 0, "gravity": 0, "save": 0}
        ...
        self.accept("m", self.setKey, ["save", True])
        self.accept("m-up", self.setKey, ["save", False])
        ...
        # AI
        self.AI = open("AI/RoamingRalph/AI_easy.txt", "w")
        self.ai_text = ""
    ...
    def move(self, task):
        ...
        x,y,z = self.Drone.getPos()
        h,p,r = self.Drone.getHpr()
        self.ai_text += str(x)+" "+str(y)+" "+str(z)+" "+str(h)+" "+str(p)+" "+str(r)+"\n"
